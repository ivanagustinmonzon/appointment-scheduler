...
def _click_speciality_button(driver, speciality):
...
def _open_specialities_section(driver):
...
def _extract_next_appointment_availability(driver):
...
def _get_next_speciality_availability(driver, speciality):
    doctors_section_id = "id01"
    doctors_section_show_id = "button_5"

    _open_specialities_section(driver)

    _click_speciality_button(driver, speciality)

    available_date = _extract_next_appointment_availability(driver)

    return available_date

def _print_availability(configured_days, configured_speciality, availablilty_datetime):
...
if __name__ == "__main__":
    ...
    availablilty_datetime = _get_next_speciality_availability(logged_driver, speciality)

    body = _print_availability(max_days, speciality, availablilty_datetime)
